...
const getSkyDisplay = (option) => {
  ...
  return skyOptions[option] || skyOptions['Sunny'];
};

const updateSkyDisplay = (option) => {
  if (!skyElement) {
    return;
  }
...
const registerEventHandlers = () => {
  ...
  if (skySelectElement) {
    skySelectElement.addEventListener('change', skySelectDropDwon);
  }

  // Initialize sky to default option
  updateSkyDisplay('Sunny');
